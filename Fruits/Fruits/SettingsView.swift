			...
			ScrollView(.vertical, showsIndicators: false) {
				VStack(spacing: 20) {
					...
					GroupBox(label: SettingsLabelView(labelText: "Customization",
						...
						Divider().padding(.vertical, 4)
						Text("If you wish, you can restart the application by toggle the switch in this box. It starts the onboarding process and you will see the welcome screen again.")
							.padding(.vertical, 8)
							.frame(minHeight: 80)
							.layoutPriority(1)
							.font(.footnote)
